...
$status=1;
$query=mysqli_query($con,"update tbl_popup set buttontitle='$buttontitle',buttonurl='$buttonurl',imgTitle='$imgnewfile' Where id = 1");
if($query)
{
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" id="buttontitle" name="buttontitle">
