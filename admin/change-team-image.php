...
$query=mysqli_query($con,"update tbl_team set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
            ...
            <div class="content">
                <div class="container">
                    ...
                    <form name="addpost" method="post" enctype="multipart/form-data">
                        <?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostImage,membername from tbl_team where id='$postid' and Is_Active=1 ");
                                        ...
                                        <form name="addpost" method="post">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="membername"
                                                    value="<?php echo htmlentities($row['membername']);?>"
                                                    name="membername" readonly>
                                            </div>
