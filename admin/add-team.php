...
$status=1;
$query=mysqli_query($con,"insert into tbl_team(membername,role,memberdescription,PostUrl,Is_Active,PostImage,postedBy) values('$membername','$role','$memberdescription','$url','$status','$imgnewfile','$postedby')");
if($query)
{
