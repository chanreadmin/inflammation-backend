...
$query=mysqli_query($con,"update tbl_sircon set PostTitle='$posttitle',sirconyear='$sirconyear',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status',lastUpdatedBy='$lastuptdby' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select * from tbl_sircon where id='$postid' and Is_Active=1 ");
                                    ...
                                    <form name="addpost" method="post">
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" id="posttitle"
                                                value="<?php echo htmlentities($row['PostTitle']);?>" name="posttitle"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <br />
                                                    <a
                                                        href="change-sircon-image.php?pid=<?php echo htmlentities($row['id']);?>">Update
                                                        Image</a>
                                                </div>
                                            </div>
                                        </div>
