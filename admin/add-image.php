...
$status=1;
$query=mysqli_query($con,"insert into tbl_gallery(postyear,Is_Active,PostImage,postedBy) values('$postyear','$status','$imgnewfile','$postedby')");
if($query)
{
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" id="postyear" name="postyear">
